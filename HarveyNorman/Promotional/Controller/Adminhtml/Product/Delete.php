...
class Delete extends \HarveyNorman\Promotional\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $model = $this->_objectManager->create(\HarveyNorman\Promotional\Model\Product::class);
                $model->load($id);
                $model->delete();
